...
We evaluate 17 state-of-the-art Video Language Models on CLIP-CC-Bench using three evaluation families to analyze their long-form video description capabilities.
...
\begin{table}[t]
\centering
\caption{Video Language Models evaluated on CLIP-CC-Bench.}
\label{tab:models}
